...
private def faceSWVertex (n : Nat) (c : FKIsingSquareFullFaceNode n) :
...
private def faceSEVertex (n : Nat) (c : FKIsingSquareFullFaceNode n) :
    FKIsingSquareFullVertexNode n := by
  let p := fkIsingSquareInteriorCellKey n c
  have hp := fkIsingSquareInteriorCellKey_interior n c
  change -(n : Int) ≤ p.1 ∧ p.1 < (n : Int) ∧
...
private def faceNWVertex (n : Nat) (c : FKIsingSquareFullFaceNode n) :
    FKIsingSquareFullVertexNode n := by
  let p := fkIsingSquareInteriorCellKey n c
  have hp := fkIsingSquareInteriorCellKey_interior n c
  change -(n : Int) ≤ p.1 ∧ p.1 < (n : Int) ∧
...
private def faceNEVertex (n : Nat) (c : FKIsingSquareFullFaceNode n) :
    FKIsingSquareFullVertexNode n := by
  let p := fkIsingSquareInteriorCellKey n c
  have hp := fkIsingSquareInteriorCellKey_interior n c
  change -(n : Int) ≤ p.1 ∧ p.1 < (n : Int) ∧
...
private theorem faceNorthEdge_eq_west (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
...
private theorem faceEastEdge_eq_south (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
...
private theorem faceSouthEdge_eq_west (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
...
private def faceSouthWestDart (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
...
private theorem faceSouthWest_bondMate (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) :
...
private def faceWestEastDart (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
    FKIsingSquareInteriorRadialDart n :=
...
private theorem faceWestEast_bondMate (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) :
...
private def faceNorthEastDart (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
    FKIsingSquareInteriorRadialDart n :=
...
private theorem faceNorthEast_bondMate (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) :
...
private def faceEastWestDart (n : Nat)
    (c : FKIsingSquareFullFaceNode n) :
    FKIsingSquareInteriorRadialDart n :=
...
private theorem faceEastWest_bondMate (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) :
...
theorem fkIsingSquareFullFaceFullObservable_quad (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) :
    IsingSquareSHolomorphicQuad
      (fkIsingSquareWiredFullMedialObservable n hn (faceNorthEdge n c))
      (fkIsingSquareWiredFullMedialObservable n hn (faceEastEdge n c))
      (fkIsingSquareWiredFullMedialObservable n hn (faceSouthEdge n c))
      (fkIsingSquareWiredFullMedialObservable n hn (faceWestEdge n c)) := by
  ...
  · calc
      ...
      _ = (fkIsingSquareWiredDobrushinDomain n hn).fermionicObservable
          (.dart (eS, .west)) := by
        simpa [south] using
          fkIsingSquareWiredFullMedialObservable_projection n hn eS .west
      _ = (fkIsingSquareWiredDobrushinDomain n hn).fermionicObservable
      ...
      _ = isingProj
        ...
        symm
        simpa [west] using
          fkIsingSquareWiredFullMedialObservable_projection n hn eW .south
  ...
  · calc
      ...
      _ = (fkIsingSquareWiredDobrushinDomain n hn).fermionicObservable
          (.dart (eN, .east)) := by
        simpa [north] using
          fkIsingSquareWiredFullMedialObservable_projection n hn eN .east
      _ = (fkIsingSquareWiredDobrushinDomain n hn).fermionicObservable
      ...
      _ = isingProj
        ...
        symm
        simpa [east] using
          fkIsingSquareWiredFullMedialObservable_projection n hn eE .north
...
private def faceNorthNeighbor (n : Nat) (c : FKIsingSquareFullFaceNode n)
    (h : c.2.1 + 1 < 2 * n) : FKIsingSquareFullFaceNode n :=
  (c.1, ⟨c.2.1 + 1, h⟩)

private def faceEastNeighbor (n : Nat) (c : FKIsingSquareFullFaceNode n)
    (h : c.1.1 + 1 < 2 * n) : FKIsingSquareFullFaceNode n :=
  (⟨c.1.1 + 1, h⟩, c.2)

private def faceSouthNeighbor (n : Nat) (c : FKIsingSquareFullFaceNode n)
    (h : 0 < c.2.1) : FKIsingSquareFullFaceNode n :=
  (c.1, ⟨c.2.1 - 1, by omega⟩)

private def faceWestNeighbor (n : Nat) (c : FKIsingSquareFullFaceNode n)
    (h : 0 < c.1.1) : FKIsingSquareFullFaceNode n :=
  (⟨c.1.1 - 1, by omega⟩, c.2)

theorem fkIsingSquareFullFace_neighborFinset (n : Nat)
    (c : FKIsingSquareFullFaceNode n)
    (heast : c.1.1 + 1 < 2 * n)
    (hnorth : c.2.1 + 1 < 2 * n)
...
private theorem face_difference_north (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) (hnorth : c.2.1 + 1 < 2 * n) :
    FKIsingSquareFullIntegratedPrimitive.facePrimitive n hn
          (faceNorthNeighbor n c hnorth) -
        FKIsingSquareFullIntegratedPrimitive.facePrimitive n hn c =
...
private theorem face_difference_east (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) (heast : c.1.1 + 1 < 2 * n) :
    FKIsingSquareFullIntegratedPrimitive.facePrimitive n hn
...
private theorem face_difference_south (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) (hsouth : 0 < c.2.1) :
    FKIsingSquareFullIntegratedPrimitive.facePrimitive n hn
...
private theorem face_difference_west (n : Nat) (hn : 0 < n)
    (c : FKIsingSquareFullFaceNode n) (hwest : 0 < c.1.1) :
    FKIsingSquareFullIntegratedPrimitive.facePrimitive n hn
...
theorem face_laplacian_nonneg_of_interior (n : Nat) (hn : 0 < n)
  ...
  let eS := faceSouthEdge n c
  let eW := faceWestEdge n c
  let H := FKIsingSquareFullIntegratedPrimitive.facePrimitive n hn
  ...
  have hLap : isingFiniteGraphLaplacian (fkIsingSquareFullFaceGraph n) H c =
    ...
    simp only [fkIsingSquareFullFace_neighborFinset n c heast hnorth hwest hsouth]
  ...
  exact isingPrimalPrimitiveLaplacian_nonneg _ _ _ _
    (fkIsingSquareFullFaceFullObservable_quad n hn c)
